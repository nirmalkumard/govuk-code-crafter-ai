...
const CodePreview: React.FC<CodePreviewProps> = ({ html, className }) => {
    ...
    <div class="govuk-width-container">
      <div class="govuk-breadcrumbs">
        <ol class="govuk-breadcrumbs__list">
          ...
          <li class="govuk-breadcrumbs__list-item">
            <a class="govuk-breadcrumbs__link" href="#">Code generator</a>
          </li>
          <li class="govuk-breadcrumbs__list-item" aria-current="page">Generate new code</li>
        </ol>
      </div>
        ...
        <div class="govuk-grid-row">
          ...
          <div class="govuk-grid-column-one-third">
            <div class="govuk-panel govuk-panel--confirmation">
              <h2 class="govuk-panel__title">Ready to generate</h2>
              <div class="govuk-panel__body">
                Type your request in the<br>chat interface
              </div>
            </div>
          </div>
        </div>
  ...
  // Enhanced GOV.UK Design System CSS inclusion with local file
